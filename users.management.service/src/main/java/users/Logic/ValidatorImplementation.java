...
import users.Exceptions.InvalidSortByException;
import users.Exceptions.InvalidSortOrderException;
...
public class ValidatorImplementation implements Validator {
	...
	@Override
	public boolean isValidSortOrder(String order) {
		if( order.equals("ASC") || order.equals("DESC") )
			return true;
		throw new InvalidSortOrderException("Order must be ASC/DESC");
	}

	@Override
	public boolean isValidSortBy(String sortAttribute) {
		if( sortAttribute.equals("firstName") || 
				 sortAttribute.equals("lastName") ||
				 sortAttribute.equals("email")||
				 sortAttribute.equals("birthDate")||
				 sortAttribute.equals("roles")||
				 sortAttribute.equals("password"))
			return true;
		throw new InvalidSortByException("Sort Attribute must be firstName/lastName/email/birthDate/roles/password");
	}
