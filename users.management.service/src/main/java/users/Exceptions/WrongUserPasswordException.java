...
public class WrongUserPasswordException extends RuntimeException {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 3533130391570510661L;
	...
	public WrongUserPasswordException(String message, Throwable cause, boolean enableSuppression,
